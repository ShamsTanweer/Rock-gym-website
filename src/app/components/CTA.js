      ...
      <div className="container mx-auto space-y-16">
        ...
        >
          ...
          <div className="absolute flex flex-col items-center justify-center text-center space-y-6 px-4 sm:px-12 w-full max-w-4xl">
            <motion.h2
              className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-red-500 w-full"
            ...
            >
              Join us today to benefit from personalized guidance from fitness experts.
            </motion.p>
            <motion.p
